...
<html>
	...
	<body>
		<div class="container">
			<h1 class="heading">Welcome to the Automobiles Database</h1>
							...
							<tbody>
								<?php foreach($autos as $auto) : ?>
			                        <tr>
										...
										<td><a href="edit.php?auto_id=<?php echo $auto->auto_id; ?>">Edit</a> / <a href="delete.php?auto_id=<?php echo $auto->auto_id; ?>">Delete</a></td>
			                        </tr>
			                    <?php endforeach; ?>
							</tbody>
						</table>
